...
public:
	...
	void Init()
	{
		...
		// 배경 모델 추가
		//----------------------------------------------------------------------------------------------------//
		mModelManager->AddModel(0, "MapObj1",  200.0f, 5.0f, 1900.0f, 1.2f, 1.2f, 1.2f); // 풍차
		mModelManager->AddModel(1, "MapObj1", -500.0f, 5.0f, 2100.0f);					 // 풍차

		mModelManager->AddModel(0, "MapObj3" , 1550.0f, 0.0f, 1700.0f, 1.0f, 1.5f, 1.0f); // 작은 건물2
		mModelManager->AddModel(1, "MapObj3" , 1400.0f, 0.0f, 1700.0f, 1.0f, 1.5f, 1.0f); 
		mModelManager->AddModel(2, "MapObj3" , 1250.0f, 0.0f, 1700.0f, 1.0f, 1.5f, 1.0f); 
		mModelManager->AddModel(3, "MapObj3" , 1100.0f, 0.0f, 1700.0f, 1.0f, 1.5f, 1.0f);
		...
		mModelManager->AddModel(0, "MapObj7" , -1250.0f, 0.0f, -1550.0f, 2.5f, 2.5f, 2.5f); // 위로 큰 건물
		mModelManager->AddModel(1, "MapObj7" ,  2200.0f, 0.0f, -1750.0f, 2.5f, 2.5f, 2.5f); 
		mModelManager->AddModel(2, "MapObj7",   2200.0f, 0.0f, -1300.0f, 2.5f, 2.5f, 2.5f);

		mModelManager->AddModel(0, "MapObj9" , -1650.0f,-50.0f,  1500.0f, 2.5f, 3.2f, 5.f); // 뚫린 조그만 건물
		mModelManager->AddModel(0, "MapObj10", -1650.0f,-50.0f,  1500.0f, 2.5f, 3.2f, 5.f); // 지붕

		mModelManager->AddModel(0, "MapObj5" , -430.0f,  20.0f, -1900.0f, 2.5f, 3.2f, 1.f); // 길쭉한 건물
		mModelManager->AddModel(0, "MapObj15", -430.0f, 170.0f, -1900.0f, 2.5f, 3.2f, 1.f); // 지붕

		mModelManager->AddModel(1, "MapObj5" , -950.0f,  20.0f, -1900.0f, 2.5f, 3.2f, 1.f); // 길쭉한 건물
		mModelManager->AddModel(1, "MapObj15", -950.0f, 170.0f, -1900.0f, 2.5f, 3.2f, 1.f); // 지붕

		mModelManager->AddModel(0, "MapObj11",  620.0f, 0.0f,  1750.0f, 1.2f, 1.2f, 1.f); // 큰 건물
		mModelManager->AddModel(0, "MapObj12",  620.0f, 0.0f,  1750.0f, 1.2f, 1.2f, 1.f); // 지붕 
		
		mModelManager->AddModel(0, "MapObj13",  1700.0f, 0.0f, 150.0f, 2.0f, 2.0f, 2.2f); // 마을 회관 급
		...
		mModelManager->AddModel(0, "MapObj23",    50.0f,  0.0f, -1950.0f, 1.5f, 1.5f, 1.5f); // 지붕있는 풍차
