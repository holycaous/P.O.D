...
public:
	...
	void SetDirVector(FLOAT x, FLOAT y, FLOAT z) { m_dirX = x; m_dirY = y; m_dirZ = z;  }
	FLOAT GetDirVectorX() { return m_dirX; }
	FLOAT GetDirVectorY() { return m_dirY; }
	FLOAT GetDirVectorZ() { return m_dirZ; }
